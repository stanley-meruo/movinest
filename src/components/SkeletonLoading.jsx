...
const SkeletonLoading = () => {
  return (
    <section className="grid bg-neutral-800 py-12 px-5 xs:px-6 sm:px-8 md:py-14 md:px-10 lg:px-16 xl:px-20 xxl:px-28">
        <div className="animate-pulse mx-auto">
          ...
          {/* Line */}
          <div className="bg-neutral-700 w-full h-1 rounded-md mb-6" />
          {/* Card & Title*/}
